...
public class PrismSampleLogger : MonoBehaviour
{
    ...
    Dictionary<string, object> BuildSampleRow()
    {
        ...
        return new Dictionary<string, object>
        {
            ...
            { "ExperimentMode", runner.CurrentExperimentMode.ToString() },
            { "StudyInputMode", runner.CurrentStudyInputMode.ToString() },
            { "StudyParticipantIndex", runner.CurrentStudyParticipantIndex > 0 ? runner.CurrentStudyParticipantIndex : "" },
            { "StudyGlobalParticipantId", runner.CurrentStudyGlobalParticipantId > 0 ? runner.CurrentStudyGlobalParticipantId : "" },
            { "StudySessionIndex", runner.CurrentStudySessionIndex > 0 ? runner.CurrentStudySessionIndex : "" },
            { "StudyTaskOrder", runner.CurrentStudyTaskOrderLabel },
            { "StudyResolvedTask", runner.CurrentStudyResolvedTaskLabel },
            { "StudyResolvedEffect", runner.CurrentStudyResolvedEffectLabel },
